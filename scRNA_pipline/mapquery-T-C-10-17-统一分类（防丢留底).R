...
plots <- VlnPlot(immune.combined.sct, features = c("Plxdc2", "Saa3", "Spp1"), split.by = "orig.ident",
...
markers.to.plot <-  c( 'Mrc1','Arg1','Il1b','Nos2')
DotPlot(mac.cells, features = rev(markers.to.plot), cols = c("blue", "blue"), dot.scale = 8, 
