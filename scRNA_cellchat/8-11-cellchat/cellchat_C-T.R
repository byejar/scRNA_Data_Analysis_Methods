...
gg2 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "T_cell", signaling.exclude = c("MIF"))
#> Visualizing differential outgoing and incoming signaling changes from NL to LS
...
netVisual_bubble(cellchat, sources.use = 'Mac', targets.use = c('T_cell','NK'),  comparison = c(1, 2), angle.x = 45)
#> Comparing communications on a merged object

netVisual_bubble(cellchat, sources.use = 'fib',  comparison = c(1, 2), angle.x = 45)
#> Comparing communications on a merged object