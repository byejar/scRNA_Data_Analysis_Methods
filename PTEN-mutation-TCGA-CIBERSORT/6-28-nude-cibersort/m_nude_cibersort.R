...
write.table(df,'M_Nude.txt',row.names = F,quote = F,sep = "\t")
...
library(dplyr)
source('./Cibersort.R')
m_Nude.file <- "./M_Nude.txt"
LM22.file<-'./mics.txt'
CIBERSORT(LM22.file ,m_Nude.file, perm = 50, QN = F)  
# perm置换次数=1000
# QN如果是芯片设置为T，如果是测序就设置为F

write.csv(m_Nude.results, "./Output/m_Nude_CIBERSORT_Results.csv")
...
a<-read.csv('/home/wus/scRNA_program_blackmouseRNA/Nude/6_featureCounts/featurecount_gene_name/6-28_FPKM/CIBERSORT-Results.csv')
head(a)
